...
_EXTRA_KNOWN_ETFS: frozenset[str] = frozenset(
    {
        ...
        "SPY", "QQQ", "IWM", "DIA", "VOO", "VTI", "IVV", "SPLG", "VT", "VXUS",
        "IEFA", "EFA", "EEM", "VWO", "IEMG", "ACWI",
        # Sector SPDRs / peers
        "XLK", "XLF", "XLE", "XLV", "XLI", "XLY", "XLP", "XLU", "XLB", "XLRE", "XLC",
        "VGT", "VFH", "VDE", "VHT", "VIS", "VCR", "VDC", "VPU", "VAW", "VNQ", "VOX",
        # Bond / credit / rates
        "HYG", "JNK", "LQD", "TLT", "IEF", "SHY", "BND", "AGG", "TIP", "TIPS",
        "TBT", "TMF", "GOVT", "VCIT", "VCSH", "EMB", "BIL", "SGOV",
        # Commodities / alternatives
        "GLD", "IAU", "SLV", "USO", "UNG", "DBC", "PDBC", "DBA", "GDX", "GDXJ",
        # Thematic / industry
        "SMH", "SOXX", "IGV", "WCLD", "BOTZ", "ROBO", "HACK", "CIBR", "BUG",
        "ARKK", "ARKG", "ARKF", "ARKW", "ARKQ", "ARKX",
        "ICLN", "TAN", "QCLN", "LIT", "DRIV", "IDRV", "PBW",
        "KBE", "KRE", "KIE", "XRT", "RTH", "JETS", "PEJ",
        "IBB", "XBI", "BBH", "IHI", "PPH",
        "ITA", "PPA", "XAR", "PAVE", "IFRA",
        "SKYY", "NERD", "IPAY", "XOP", "OIH", "XME",
        # Country / region
        "MCHI", "EWT", "FXI", "KWEB", "EWJ", "EWZ", "INDA",
        # Volatility / leveraged common
        "VIXY", "UVXY", "SQQQ", "TQQQ", "SOXL", "SOXS", "SPXU", "UPRO",
        # Real estate / misc
        "IYR", "SCHH", "REM", "AMLP", "MLPA",
    }
)
...
class ETFMappingService:
    ...
    def resolve_etfs_for_themes(
        ...
        """Resolve ETFs from a list of theme dicts (as returned by _match_themes or theme hierarchy).
    ...
    def resolve_etfs_for_text(self, text: str) -> list[str]:
        """Match unstructured text (e.g. transcript narratives or mention text) against taxonomy keywords to resolve ETFs.
